...
const instruction = {
  ...
  stimulus: `
    <div style="max-width:800px; margin:auto; text-align:left;">
      ...
      <p>You will read scenarios that describe a situation, an action taken by a person, and an outcome that follows. Afterward, you will be asked to rate how likely you think the action caused the outcome.</p>
    </div>
  `,
  choices: ['Continue']
};
...
const scenarioStimuli = [
  { 
    ...
    causal_f: "Heike caused her husband’s condition to deteriorate.",
    causal_m: "Heinz caused his wife’s condition to deteriorate."
  },
  {
    id: 2,
...
// ensure gender balance: 6 female_agent + 6 male_agent in random order
...
const ratingTrials = selectedScenarios.map((scenario, idx) => {
  ...
  const causalKey  = (genderKey === 'female_agent') ? 'causal_f'  : 'causal_m';
  ...
  const causalText   = scenario[causalKey];
  ...
  return {
    ...
    html: `
      <div style="width:100%; text-align:center;">
        ...
        <input type="range" name="agree" min="0" max="100" step="1" value="50"
